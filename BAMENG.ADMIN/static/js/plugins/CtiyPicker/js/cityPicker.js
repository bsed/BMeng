 ...
 *      valType: 'k-v',                隐藏域的值类型（取值有：'k' => 只存ID，'v' => 只存名称，'k-v' => 存ID和名称，格式为：id-name）
...
(function ($) {
    $.fn.CityPicker = function (options) {
        ...
        this.template = $('<div class="IIInsomnia-city-picker" id="' + options.target + '_CityPicker"><div class="IIInsomnia-hot-wrap" style="display: none;"><p>热门城市</p><ul id="' + options.target + '_hot_city"></ul></div><div class="line" style="display: none;"></div><div class="IIInsomnia-wrap"><p>选择省份</p><ul class="IIInsomnia-province-wrap" id="' + options.target + '_province_wrap"></ul></div></div>');
        this.hot_city = $('#' + options.target + "_hot_city", this.template);
        this.province_wrap = $('#' + options.target + "_province_wrap", this.template);
        this.settings = {
            "data": options.data,
            "target": this,
            "valType": options.valType || 'v',
        ...
        this.buildProvinceTpl = function () {
            // var that = this;
        ...
        this.buildCityTpl = function (cur_province) {
            // var that = this;
        ...
        this.buildAreaTpl = function (cur_province) {
            // var that = this;
